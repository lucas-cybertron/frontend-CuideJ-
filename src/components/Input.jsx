...
<input
          ...
          className={`w-full px-3 py-2 bg-white border border-white/20 rounded-lg text-dark font-bold placeholder-gray focus:outline-none focus:ring-2 focus:ring-light focus:border-transparent transition-colors ${error ? 'border-red-500' : ''} ${className}`}
