            ...
            <form onSubmit={onsubmit} className="space-y-4">
                <div className="grid md:grid-cols-2 gap-4">
                    ...
                    <div>
                        ...
                        <select
                            ...
                            className=" w-full px-3 py-2 b-white/10 border border-white/20 rounded-lg text-dark/50 focus:outline-none focus:ring-2 focus:ring-light"
                            required
                        >
                ...
                <div>
                    ...
                    >
                        ...
                        {durations.map(duration => <option key={duration} value={duration}>Minutos</option>)}
                    </select>
                </div>
